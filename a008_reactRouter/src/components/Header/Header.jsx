                                ...
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        ...
                                        (isActive
                                            ...
                                            : "text-gray-700 hover:text-white hover:bg-orange-700 rounded-lg")
                                    }
                                >
                                    Home
                                </NavLink>
                        ...
                        <ul className="flex flex-col mt-4 font-medium">
                            <li>
                                <NavLink
                                    to="/"
                                    className={({ isActive }) =>
                                        `block py-2 pr-4 pl-3 duration-200 border-b border-gray-100 rounded-lg ` +
                                        (isActive
                                            ? "text-white bg-orange-700"
                                            : "text-gray-700 hover:text-white hover:bg-orange-700")
                                    }
